...
public:
	...
	void	draw(RenderWindow& window, int x = 0, int y = 0/*, float offsetX, float offsetY*/) {
		animList[currentAnim].sprite.setPosition(x /*- offsetX*/, y /*- offsetY*/);
		window.draw(animList[currentAnim].sprite);
	}
	/*void	drawWindow(RenderWindow& window, int x = 0, int y = 0) {
